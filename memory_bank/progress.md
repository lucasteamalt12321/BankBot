...
## last_checked_commit
aef6359 (2026-08-24) — ИИ-план дня + режим ОГЭ в проде. OGE Center: 66/100 (00/01/02/04/07 done). Остались: OGE-05 Физика → OGE-03 История TERMS → OGE-06 Экзаменатор → OGE-FULL.
