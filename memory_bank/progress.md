...
## last_checked_commit
 96891000fcbee5db9f2a2d61cbb9f97e9e3cbabe (2026-08-28; fix(music): карточка «Музыка» перенесена из свёрнутого блока «Бета-модули» в всегда видимую сетку хаба — пользователь не видел её. Задеплоено). Пред. 636f980 (отдельный Vercel-сервис аудио).
