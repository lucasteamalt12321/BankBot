...
## last_checked_commit
9e854b7 (2026-08-24) - Экзаменатор в проде. OGE Center: 96/100 - MVP завершён (все 5 предметов + ИИ-план + режим + экзаменатор). Открыт только OGE-FULL (глубокое расширение кодификатора).
