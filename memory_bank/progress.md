...
## last_checked_commit
  707268a (2026-08-28; fix(music): MUSIC_API_BASE сломан json.dumps — двойные кавычки попадали в строку -> fetch уходил на ОРИГИН LTHub, давая 413/404. Закоммичено + задеплоено на bank-bot-ruby.vercel.app). Пред. 357d969 (клиентская компрессия аудио от 413).
