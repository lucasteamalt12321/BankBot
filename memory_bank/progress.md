...
## last_checked_commit
731c453 (2026-08-24) — последний HEAD. ОГЭ-центр: Этап 0 (ядро) + Этап 1 (Математика `/math`: формулы/задачи/генератор/экзамен) задеплоены. OGE-00, OGE-01 = completed (38/100).
