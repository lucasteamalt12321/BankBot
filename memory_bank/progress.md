...
## last_checked_commit
0320d70 (2026-08-23) — последний HEAD. Темы светлая/тёмная доведены до рабочего состояния, Pico CSS v2 подключён ко всем страницам через инжектор, починен контраст прогресс-баров (императоры/информатика), в императорском модуле мастерство для бара = серия из 3 правильных ответов подряд (+ фикс фильтра по охвату). Всё задеплоено и проверено на проде.
...
## last_checked_commit
475fd50 (2026-08-20, модуль Информатика переписан под уроки ITlessons 1-9 + вкладка «📖 Теория» на /math, задеплоено на прод)
### Задача 1. Ачивки
- **Статус:** Готово
