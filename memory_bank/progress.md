...
## last_checked_commit
59cbd6f (2026-08-24) — последний HEAD. ОГЭ-центр: Этап 0 (ядро) + Этап 1 (Математика) + Этап 2 (Информатика расширена, 15 тем/75 задач, интеграция study_progress) задеплоены. OGE-00/01/02 = completed (50/100).
