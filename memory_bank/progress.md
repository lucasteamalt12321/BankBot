...
## last_checked_commit
bd694c5 (2026-08-27; Session 8a/b/c: fix экзаменатора `\'`, curator raw-JSON leak, клик по заданию открывает вкладку предмета `?tab=` + `_plan_item_tab`; деплой через CLI)
