...
## last_checked_commit
5c053df (2026-08-24) — последний HEAD кода. ОГЭ-центр: Этапы 0/1/2 + Русский язык (OGE-04) задеплоены. OGE-00/01/02/04 = completed (64/100). Следующие: OGE-05 Физика, OGE-03 История TERMS, OGE-06 Экзаменатор, OGE-FULL.
