...
| OGE-04 | Русский `/russian`: `core/russian/` — карточки правил (НН/Н, НЕ/НИ, пунктуация ССП/СПП/ДСП, обороты) + тестовые задания формата ОГЭ + чек-листы изложения/сочинения по критериям ФИПИ (без автопроверки) | pending | 14 |
...
**OGE Center: 50/100 (OGE-00, OGE-01, OGE-02 завершены 2026-08-24; генераторы/экзамен для информатики — в OGE-FULL)**
