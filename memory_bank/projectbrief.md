...
| OGE-06 | Полировка: экзамен-режимы во всех предметах (таймер, оценка по шкале ОГЭ), ачивки по предметам, статистика слабых тем на страницах | pending | 8 |
...
**OGE Center: 88/100 (OGE-00/01/02/04/07 завершены; далее Физика, История TERMS, Экзаменатор)**
