...
| OGE-FULL | Добить весь кодификатор ФИПИ по всем 5 предметам после MVP (зафиксировано пользователем как следующий шаг) | pending | 6 |

**OGE Center: 64/100 (OGE-00, OGE-01, OGE-02, OGE-04 завершены 2026-08-24; генераторы/экзамен для информатики — в OGE-FULL)**
