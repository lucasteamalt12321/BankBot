...
| OGE-12 | ИИ сам предлагает выбор темы/режима везде, где можно (баннеры-подсказки на предметных страницах и в хабе) | completed | 2 |

**OGE Center: 100/100** (Phase 6 полностью завершена: все OGE-08/09/10/11/12 закрыты)
