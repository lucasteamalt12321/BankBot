...
| D06 | Service layer (бизнес-логика из handlers) | in_progress | 7 |
...
| D11 | Блокировки балансов + Unit of Work | pending | 6 |
...
**Процент выполнения:** 40% (D01–D05, D07–D09 completed = 40/100)
