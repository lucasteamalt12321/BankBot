...
| OGE-02 | Информатика: расширение `core/informatics/` (бывш. core/math) с 9 до ~17 тем ОГЭ (системы счисления + генератор переводов, кодирование информации, логика, графы, электронные таблицы, файлы/сети) → ~120 задач; подключение серверного прогресса | pending | 12 |
...
**OGE Center: 38/100 (OGE-00, OGE-01 завершены 2026-08-24)**
