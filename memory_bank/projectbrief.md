...
| OGE-03 | История: дополнение `core/history/` — TERMS (~80 терминов ОГЭ), культура, режим «термин↔определение», переход на общий движок прогресса | pending | 10 |
...
**OGE Center: 78/100 (OGE-00/01/02/04/07 завершены; далее Физика, История TERMS, Экзаменатор)**
