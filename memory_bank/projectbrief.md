...
| OGE-05 | Физика `/physics`: `core/physics/` — шпаргалка формул по разделам (механика→квантовая), карточки «формула↔величина↔единица СИ» (matching), простые расчётные задачи | pending | 12 |
...
**OGE Center: 66/100 (OGE-00/01/02/04/07 завершены; далее Физика, История TERMS, Экзаменатор)**
