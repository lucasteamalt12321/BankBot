...
| OGE-01 | Математика `/math`: `core/mathematics/` — MVP ~130 карточек формул (сокращённое умножение, прогрессии, планиметрия, тригонометрия, вероятность) + генераторы параметрических задач (проценты, текстовые, координаты) + экзамен-режим | pending | 18 |
...
**OGE Center: 20/100 (OGE-00 завершён 2026-08-24)**
