...
- **Следующий шаг:** Этап 4 — Физика `/physics` (`core/physics/`): формулы + задачи + генераторы по образцу математики, интеграция study_progress. Затем OGE-03 История TERMS и OGE-06 Экзаменатор.
