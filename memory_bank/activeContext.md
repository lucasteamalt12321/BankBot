...
- 🔄 [TASK] Аудит багов по всему проекту (запрос пользователя): параллельно проверить core/*, api/index.py, music-подсистему; починить конкретные баги, запустить тесты. В процессе.
