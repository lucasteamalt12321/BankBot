    ...
    def test_sticker_auto_delete_without_unlimited_access_property(self, user_id, delay_minutes):
        ...
        **Validates: Requirements 2.5**
        ...
        self.assertEqual(
            ...
            "Scheduled task should have correct task type"
        )

        self.assertFalse(
            scheduled_task.is_completed,
            "Scheduled task should not be marked as completed initially"
        )
        ...
        self.assertIsNotNone(
            ...
            "Scheduled task should have task data"
        )

        task_data = scheduled_task.task_data
        self.assertEqual(
            task_data.get("message_id"), message_id,
            "Task data should contain correct message ID"
        )

        self.assertEqual(
            task_data.get("delay_minutes"), delay_minutes,
            "Task data should contain correct delay minutes"
        )
