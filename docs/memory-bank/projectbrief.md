...
| D16 | Параметрический диалоговый кодер шаблонов без таблиц пар/троек | completed | 4 |
| D17 | Аудит и очистка неиспользуемого кода, объединение дублирующихся парсеров | pending | 3 |
