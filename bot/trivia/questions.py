...
- ВСЕ четыре варианта должны быть по ТОЙ ЖЕ ТЕМЕ, что и вопрос (например, если вопрос про конфетную экономику, все варианты должны быть про конфеты/награды).
- Неправильные варианты должны звучать ПРАВДОПОДОБНО, быть в той же предметной области.
- ЗАПРЕЩЕНО использовать имена участников (Лука, Олег, Рома, Никита и т.д.) как неправильные ответы, если вопрос не про LTRS.
