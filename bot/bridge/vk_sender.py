"""VK sender for Bridge module — sends messages from Telegram to VK."""
...
from bot.bridge.loop_guard import add_bot_mark
from bot.bridge.message_queue import RateLimitError
