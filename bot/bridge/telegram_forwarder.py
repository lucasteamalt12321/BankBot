"""Telegram forwarder for Bridge module — forwards TG messages to VK via MessageQueue."""
...
from bot.bridge.config import BRIDGE_TG_CHAT_ID, VK_PEER_ID, VK_TOKEN
from bot.bridge.loop_guard import has_bot_mark
from bot.bridge.message_queue import MessageQueue, OutboundMessage
...
# Lazy-initialized queue (set during bridge startup)
