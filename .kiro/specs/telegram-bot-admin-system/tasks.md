...
- [x] 5. Реализовать команду /add_points для начисления очков
...
- [x] 6. Реализовать команду /add_admin для назначения администраторов
...
- [x] 7. Реализовать систему магазина
...
- [x] 9. Обновить существующие команды для совместимости
...
- [x] 10. Добавить комплексные property tests
...
- [x] 11. Добавить unit tests для конкретных случаев
  - [x] 11.1 Написать unit tests для форматов сообщений
  ...
  - [x] 11.2 Написать unit tests для граничных случаев
  ...
  - [x] 11.3 Написать integration tests для полного цикла
