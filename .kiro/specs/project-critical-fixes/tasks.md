...
<<<<<<< HEAD
- [ ] 3.4 Протестировать установку
  - [ ] 3.4.1 Создать чистое виртуальное окружение
  - [ ] 3.4.2 Установить зависимости
  - [ ] 3.4.3 Запустить бота
  - [ ] 3.4.4 Запустить тесты

### 4. Исправление импортов в тестах

- [ ] 4.1 Создать compatibility layer
  - [ ] 4.1.1 Создать `utils/compat.py`
  - [ ] 4.1.2 Добавить re-exports с warnings

- [ ] 4.2 Создать скрипт автоматической замены импортов
  - [ ] 4.2.1 Создать `scripts/fix_imports.py`
  - [ ] 4.2.2 Добавить mapping старых импортов на новые
  - [ ] 4.2.3 Протестировать на одном файле

- [ ] 4.3 Исправить импорты во всех тестах
  - [ ] 4.3.1 Запустить скрипт на tests/
  - [ ] 4.3.2 Вручную проверить проблемные файлы
  - [ ] 4.3.3 Исправить специфичные случаи

- [ ] 4.4 Проверить, что все тесты загружаются
  - [ ] 4.4.1 Запустить `pytest --collect-only`
  - [ ] 4.4.2 Исправить оставшиеся ошибки
  - [ ] 4.4.3 Запустить полный набор тестов
=======
...
- [x] 5.3 Мигрировать прямые SQL запросы
  - [x] 5.3.1 Найти все места с прямым SQL
  - [x] 5.3.2 Заменить на репозитории
  - [x] 5.3.3 Проверить тесты

- [x] 5.4 Пометить simple_db.py как deprecated
  - [x] 5.4.1 Добавить deprecation warning
  - [x] 5.4.2 Обновить документацию
  - [x] 5.4.3 Создать план миграции

### 6. Улучшение обработки ошибок

<<<<<<< HEAD
- [ ] 6.1 Создать middleware для обработки ошибок
  - [x] 6.1.1 Создать `bot/middleware/error_handler.py`
  - [ ] 6.1.2 Реализовать обработку исключений
  - [ ] 6.1.3 Добавить уведомления администратора
=======
- [x] 6.1 Создать middleware для обработки ошибок
  - [x] 6.1.1 Создать `bot/middleware/error_handler.py`
  - [x] 6.1.2 Реализовать обработку исключений
  - [x] 6.1.3 Добавить уведомления администратора
>>>>>>> f1369b8 (chore: minor update, possibly buggy)

- [x] 6.2 Интегрировать middleware в бота
  - [x] 6.2.1 Зарегистрировать middleware
  - [x] 6.2.2 Протестировать на разных типах ошибок

- [x] 6.3 Добавить тесты для обработки ошибок
  - [x] 6.3.1 Unit тесты для middleware
  - [x] 6.3.2 Integration тесты для различных сценариев
  - [x] 6.3.3 Property-based тесты для устойчивости

### 7. Унификация конфигурации парсинга

- [x] 7.1 Создать модель ParsingRule
  - [x] 7.1.1 Добавить модель в `src/models/`
  - [x] 7.1.2 Создать миграцию БД
  - [x] 7.1.3 Написать тесты

- [x] 7.2 Создать ParsingConfigManager
  - [x] 7.2.1 Создать `core/managers/parsing_config_manager.py`
  - [x] 7.2.2 Реализовать API управления
  - [x] 7.2.3 Написать тесты

- [x] 7.3 Мигрировать данные из coefficients.json
  - [x] 7.3.1 Создать скрипт миграции
  - [x] 7.3.2 Запустить миграцию
  - [x] 7.3.3 Проверить данные

- [x] 7.4 Обновить парсеры для использования БД
  - [x] 7.4.1 Обновить все парсеры
  - [x] 7.4.2 Удалить старую конфигурацию
  - [x] 7.4.3 Проверить тесты

### 8. Валидация окружения

- [x] 8.1 Создать StartupValidator
  - [x] 8.1.1 Создать `src/startup_validator.py`
  - [x] 8.1.2 Реализовать проверки
  - [x] 8.1.3 Написать тесты

- [x] 8.2 Интегрировать валидацию в main.py
  - [x] 8.2.1 Добавить вызов при старте
  - [x] 8.2.2 Протестировать с разными конфигурациями

- [x] 8.3 Добавить значения по умолчанию
  - [x] 8.3.1 Определить необязательные параметры
  - [x] 8.3.2 Добавить defaults в Settings
  - [x] 8.3.3 Документировать defaults

### 9. Безопасное завершение процессов

- [x] 9.1 Создать ProcessManager
  - [x] 9.1.1 Создать `src/process_manager.py`
  - [x] 9.1.2 Реализовать PID management
  - [x] 9.1.3 Написать тесты

- [x] 9.2 Реализовать graceful shutdown
  - [x] 9.2.1 Добавить обработку сигналов
  - [x] 9.2.2 Реализовать закрытие ресурсов
  - [x] 9.2.3 Протестировать shutdown

- [x] 9.3 Обновить скрипты запуска
  - [x] 9.3.1 Обновить `run_bot.py`
  - [x] 9.3.2 Удалить старую логику kill_processes
  - [x] 9.3.3 Документировать новый подход

### 10. Рефакторинг монолитного bot.py

- [x] 10.1 Создать структуру модулей
  - [x] 10.1.1 Создать директории bot/commands/
  - [x] 10.1.2 Создать файлы для групп команд
  - [x] 10.1.3 Создать router.py

- [x] 10.2 Разделить команды по модулям
  - [x] 10.2.1 Переместить admin команды
  - [x] 10.2.2 Переместить user команды
  - [x] 10.2.3 Переместить shop команды
  - [x] 10.2.4 Переместить game команды
  - [x] 10.2.5 Переместить system команды

- [x] 10.3 Создать систему регистрации команд
  - [x] 10.3.1 Реализовать router
  - [x] 10.3.2 Обновить main.py
  - [x] 10.3.3 Протестировать все команды

- [x] 10.4 Обновить тесты
  - [x] 10.4.1 Обновить импорты в тестах
  - [x] 10.4.2 Проверить все тесты
  - [x] 10.4.3 Добавить новые тесты при необходимости

### 11. Разделение уровней абстракции

- [x] 11.1 Создать service layer
  - [x] 11.1.1 Создать `core/services/user_service.py`
  - [x] 11.1.2 Создать `core/services/transaction_service.py`
  - [x] 11.1.3 Создать `core/services/shop_service.py`
  - [x] 11.1.4 Написать unit тесты для сервисов

- [ ] 11.2 Вынести бизнес-логику из handlers
  - [x] 11.2.1 Рефакторить user commands
  - [x] 11.2.2 Рефакторить shop commands
  - [x] 11.2.3 Рефакторить admin commands
