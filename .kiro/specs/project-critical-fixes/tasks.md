...
- [ ] 1.1 Создать новый `src/config.py` с Pydantic Settings
...
- [ ] 1.2 Добавить deprecation warnings в старые config файлы
...
- [ ] 1.3 Обновить все импорты конфигурации
...
- [ ] 1.4 Удалить старые config файлы
  - [x] 1.4.1 Удалить `utils/config.py`
  - [x] 1.4.2 Удалить `utils/core/config.py`
  - [-] 1.4.3 Обновить документацию

### 2. Вынос конфиденциальных данных

- [ ] 2.1 Создать `.env.example` с документацией
  - [~] 2.1.1 Добавить все необходимые переменные
  - [~] 2.1.2 Добавить комментарии с описанием
  - [~] 2.1.3 Добавить примеры значений

- [ ] 2.2 Добавить ADMIN_TELEGRAM_ID в Settings
  - [~] 2.2.1 Добавить поле в класс Settings
  - [~] 2.2.2 Добавить валидацию
  - [~] 2.2.3 Написать тесты

- [ ] 2.3 Заменить хардкод на переменные окружения
  - [~] 2.3.1 Создать скрипт поиска хардкода `scripts/find_hardcoded_ids.py`
  - [~] 2.3.2 Найти все 20+ мест с ID 2091908459
  - [~] 2.3.3 Заменить на `settings.ADMIN_TELEGRAM_ID`
  - [~] 2.3.4 Проверить все тесты

- [ ] 2.4 Обновить документацию по развертыванию
  - [~] 2.4.1 Добавить раздел "Environment Variables" в README
  - [~] 2.4.2 Обновить инструкции по установке

### 3. Исправление зависимостей

- [ ] 3.1 Создать правильный `requirements.txt`
  - [~] 3.1.1 Собрать все production зависимости
  - [~] 3.1.2 Закрепить версии
  - [~] 3.1.3 Добавить комментарии к группам зависимостей

- [ ] 3.2 Создать `requirements-dev.txt`
  - [~] 3.2.1 Переместить тестовые библиотеки
  - [~] 3.2.2 Добавить линтеры и форматтеры
  - [~] 3.2.3 Добавить инструменты разработки

- [ ] 3.3 Создать `requirements-docs.txt`
  - [~] 3.3.1 Добавить Sphinx
  - [~] 3.3.2 Добавить темы и расширения
...
- [ ] 5.1 Создать базовый репозиторий
  - [ ] 5.1.1 Создать `src/repository/base.py`
  - [ ] 5.1.2 Реализовать CRUD операции
  - [ ] 5.1.3 Написать unit тесты
  - [ ] 5.1.4 Написать property-based тесты

- [ ] 5.2 Создать UserRepository
  - [ ] 5.2.1 Создать `src/repository/user_repository.py`
  - [ ] 5.2.2 Реализовать специфичные методы
  - [ ] 5.2.3 Написать тесты
